...
<head>
    ...
    <title>Exercise 1: Getting Started with PHP - Keshav Sapkota</title>
</head>
<body>
...
<h3>3.2 Create a PHP variable named $title and assign it 
        the value of "PHP is interestin."
    ...
    <h3>Take a screenshot that confirms your 
     ...
     <img src="img/docker_img.png" alt="web development environment">      
    </body>
</html>